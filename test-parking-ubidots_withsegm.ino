...
//int carstate = 0000;  //uncomment or delete
int delaytime = 5;
...
int pinD1 = 9;
int pinD2 = 10;
int pinD3 = A2;  //uncomment or delete
int pinD4= A3;


const int EntrySensor = 12;
const int ExitSensor = 11;
const int EmptyLED = A7;
const int FilledLED = A6;
...
// pinMode(pinD3, OUTPUT); // uncomment or delete
// pinMode(pinD4, OUTPUT); // uncomment or delete
...
pinMode(pinF, OUTPUT);
pinMode(pinG, OUTPUT);
// pinMode(pinDP, OUTPUT); // uncomment or delete
...
if (pulseIn(EntrySensor, LOW, 5000)&& (CarState < GarageCap)) 
{
  ...
  //delay (500);        // just a processing delay
...
if (pulseIn(ExitSensor, LOW, 5000) && CarExit < CarEntry) { // sensor detects car exit
  ...
  //delay (1000);        // just a processing delay // waits for 0.1 second
  CarState = CarEntry - CarExit;
